...
//        inMemoryTaskManager.epics.put(epicId, epic);
//
...
//        Epic savedEpic = inMemoryTaskManager.epics.get(epic.getId());
//
...
//        inMemoryTaskManager.addEpic(epic);
//        inMemoryTaskManager.addSubtask(subtask);
//        assertFalse(inMemoryTaskManager.epics.isEmpty(), "не должен быть пустой");
//        assertFalse(inMemoryTaskManager.subtasks.isEmpty(), "не должен быть пустой");
//        inMemoryTaskManager.clearEpics();
//        assertTrue(inMemoryTaskManager.epics.isEmpty(), "должен быть пустой");
